...
class Creare_Customcontacts_IndexController extends Mage_Core_Controller_Front_Action
{
    ...
    {
        $this->loadLayout();
        $this->getLayout()->getBlock('customcontactform')
    ...
    public function sendAction()
    {
        ...
        if ( $post ) {
            ...
            try {
                ...
                Mage::getSingleton('customer/session')->addError(Mage::helper('customcontacts')->__('Sorry, we were unable to submit your enquiry.'));
                $this->_redirect('*/*/');
                return;
            }
